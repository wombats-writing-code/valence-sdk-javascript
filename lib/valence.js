...
D2L.Util = {
  ...
  /** Modified to be more modular; removes jsSHA **/
  var crypto = require('crypto-js');
  var buffer = require('buffer').Buffer;
  function getHMAC (data, key) {
    var hash = crypto.HmacSHA256(data, key).toString(crypto.enc.HEX);
    var b = new buffer(hash, 'hex');
    return b.toString('base64');
  }
  console.log(getHMAC(data, key));
  return D2L.Util.base64Url(getHMAC(data, key));
	},
